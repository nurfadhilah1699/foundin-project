...
@section('content')
  <section class="content">
    <!-- Search -->
    <form action="{{ route('admin.posts.index') }}" method="GET" class="form-inline mb-3">
      <input type="text" name="search" value="{{ request('search') }}" class="form-control mr-2" placeholder="Search post...">
      <button type="submit" class="btn btn-primary">Search</button>
      <a href="{{ route('admin.posts.index') }}" class="btn btn-secondary ml-2">Reset</a>
    </form>
